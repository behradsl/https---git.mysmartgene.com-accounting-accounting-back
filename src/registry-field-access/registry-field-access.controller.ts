...
export class RegistryFieldAccessController {
  ...
  @Roles('ADMIN')
  @Post('/assign')
  async upsertMany(@Body() args: CreateRegistryFieldAccessArrayDto) {
  ...
  async findByPosition(
    @Param() args: RegistryFieldAccessFindByPositionNameDto,
  ) {
  ...
  async findVisibleFields(
    ...
    return await this.registryFieldAccessService.findVisibleFields(
      args.position,
    );
  }
}
