...
import { IsBoolean, IsEnum, IsISO8601, IsString, IsUUID, IsOptional } from "class-validator";
...
export class CreateRegistryDto {
  ...
  @ApiProperty({ description: "Customer relation info", example: "09391115840" })
  @IsString()
  @IsOptional()
  costumerRelationInfo?: string;

  @ApiProperty({ description: "Date of sending sample to Korea", example: "2025-02-01T00:00:00.000Z" })
  @IsISO8601()
  @IsOptional()
  ...
  @ApiProperty({ description: "Result ready time", example: "2025-02-01T00:00:00.000Z" })
  @IsISO8601()
  @IsOptional()
  ...
  @ApiProperty({ description: "Indicates if proforma has been sent", example: false })
  @IsBoolean()
  @IsOptional()
  proformaSent?: boolean;

  @ApiProperty({ description: "Proforma sent date", example: "2025-02-01T00:00:00.000Z" })
  @IsISO8601()
  @IsOptional()
  ...
  @ApiProperty({ description: "Installment one date", example: "2025-02-01T00:00:00.000Z" })
  @IsISO8601()
  @IsOptional()
  ...
  @ApiProperty({ description: "Installment two date", example: "2025-02-01T00:00:00.000Z" })
  @IsISO8601()
  @IsOptional()
  ...
  @ApiProperty({ description: "Installment three date", example: "2025-02-01T00:00:00.000Z" })
  @IsISO8601()
  @IsOptional()
  ...
  @ApiProperty({ description: "Settlement date", example: "2025-02-01T00:00:00.000Z" })
  @IsISO8601()
  @IsOptional()
  settlementDate?: string;

  @ApiProperty({ description: "Indicates if official invoice was sent", example: false })
  @IsBoolean()
  @IsOptional()
  officialInvoiceSent?: boolean;

  @ApiProperty({ description: "Official invoice sent date", example: "2025-02-01T00:00:00.000Z" })
  @IsISO8601()
  @IsOptional()
