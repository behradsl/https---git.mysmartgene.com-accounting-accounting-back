...
export class RegistryExportService {
    ...
    async generateExcel(res: Response) {
        ...
        worksheet.addRow([
          'MotId', 'نام', 'نام آزمایشگاه', 'توع سرویس', 'نوع کیت',
          'وضعیت اظطرار', 'قیمت', 'توضیحات', 'اطلاعات مشتری', 
          'وضعیت آماده بودن جواب', 'زمان آماده شدن', 'وضعیت فاکتور',
          'مقدار کل فاکتور', 'مجموع پرداختی', 'زمان تسویه', 
        ...
        registries.forEach(registry => {
          worksheet.addRow([
            ...
            registry.resultReadyTime ? registry.resultReadyTime.toISOString() : 'N/A',
        ...
        res.setHeader('Content-Disposition', 'attachment; filename=registries.xlsx');
